...
export default function App() {
  const [tab, setTab] = useState(() =>
    window.location.pathname === '/subscribe' ? 'subscribers' : 'dashboard'
  );
  ...
  useEffect(() => {
    ...
    const onPopState = () => {
      setTab(window.location.pathname === '/subscribe' ? 'subscribers' : 'dashboard');
    };
  ...
  function switchTab(nextTab) {
    setTab(nextTab);
    const path = nextTab === 'subscribers' ? '/subscribe' : '/';
