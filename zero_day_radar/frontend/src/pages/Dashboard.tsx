...
import { RefreshCw, Radio, Wifi, WifiOff, Briefcase, Camera, Globe, MessageSquare, Share2 } from 'lucide-react'
...
export function Dashboard() {
  ...
  const [worker, setWorker] = useState<{ redis_ok: boolean; beat_interval_minutes: number } | null>(null)
